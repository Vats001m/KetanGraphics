...
import { Mail, Phone, MapPin, CheckCircle, Star, Users, Clock, Award, Camera, Instagram, Facebook, MessageCircle, Map, Printer, Package, FileText, Palette, Zap, Shield } from 'lucide-react';
...
function App() {
          ...
          <div className="flex items-center space-x-3 cursor-pointer" onClick={() => setCurrentPage('home')}>
            ...
            <div>
              <div className="flex items-center">
                ...
                <span className="text-2xl font-bold text-white ml-2">GRAPHICS</span>
              </div>
              <div className="text-xs text-gray-400 font-medium tracking-wider">ONE STOP PRINTING SOLUTION</div>
            </div>
          </div>
          <nav className="hidden md:flex space-x-8">
            <button 
              onClick={() => setCurrentPage('home')} 
              className={`font-medium transition-colors ${currentPage === 'home' ? 'text-red-400' : 'text-gray-400 hover:text-red-400'}`}
            >
              Home
            </button>
            <button 
              onClick={() => setCurrentPage('services')} 
              className={`font-medium transition-colors ${currentPage === 'services' ? 'text-red-400' : 'text-gray-400 hover:text-red-400'}`}
            >
              Services
            </button>
            <button 
              onClick={() => setCurrentPage('gallery')} 
              className={`font-medium transition-colors ${currentPage === 'gallery' ? 'text-red-400' : 'text-gray-400 hover:text-red-400'}`}
            >
              Gallery
            </button>
            <button 
              onClick={() => setCurrentPage('about')} 
              className={`font-medium transition-colors ${currentPage === 'about' ? 'text-red-400' : 'text-gray-400 hover:text-red-400'}`}
            >
              About
            </button>
            <button 
              onClick={() => setCurrentPage('contact')} 
              className={`font-medium transition-colors ${currentPage === 'contact' ? 'text-red-400' : 'text-gray-400 hover:text-red-400'}`}
            >
              Contact
            </button>
          </nav>
    ...
    <footer className="bg-black text-white py-12 border-t border-gray-900">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="flex items-center space-x-3 mb-4">
              ...
              <div>
                <div className="flex items-center">
                  ...
                  <span className="text-xl font-bold text-white ml-2">GRAPHICS</span>
                </div>
                <div className="text-xs text-gray-500 font-medium tracking-wider">ONE STOP PRINTING SOLUTION</div>
              </div>
            </div>
            <p className="text-gray-500">
              Your complete printing solution with professional multi-colour offset printing services and vibrant color reproduction.
            </p>
          </div>
        ...
        <div className="border-t border-gray-900 mt-8 pt-8 text-center text-gray-500">
          <p>&copy; 2024 Ketan Graphics. All rights reserved. | One Stop Printing Solution</p>
        </div>
      </div>
    </footer>
  );
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="bg-gray-900 p-8 rounded-xl hover:shadow-2xl transition-shadow border-t-4 border-magenta-500 hover:bg-gray-800">
              <div className="w-12 h-12 bg-magenta-500/20 rounded-lg flex items-center justify-center mb-6">
                <Package className="h-6 w-6 text-magenta-400" />
              </div>
              ...
              <button 
                onClick={() => setCurrentPage('services')}
                className="text-magenta-400 hover:text-magenta-300 font-medium transition-colors"
              >
                Learn More →
              </button>
            </div>
        ...
        <div className="grid lg:grid-cols-2 gap-12 mb-16">
          ...
          <div className="bg-gray-950 p-8 rounded-xl border border-gray-800 hover:border-red-500/50 transition-colors">
            ...
            <p className="text-gray-300 mb-6">
              State-of-the-art digital printing technology for quick, high-quality results. 
              Perfect for small to medium runs with exceptional color accuracy and detail.
            </p>
          ...
          <div className="bg-gray-950 p-8 rounded-xl border border-gray-800 hover:border-cyan-400/50 transition-colors">
            ...
            <p className="text-gray-300 mb-6">
              ...
              Superior quality with consistent color reproduction and cost-effective pricing.
            </p>
            <div className="grid md:grid-cols-2 gap-4">
              <div className="space-y-3">
                <div className="flex items-center text-gray-300">
          ...
          <div className="bg-gray-950 p-8 rounded-xl border border-gray-800 hover:border-magenta-500/50 transition-colors">
            ...
            <p className="text-gray-300 mb-6">
              Eye-catching large format printing for advertising, events, and promotional displays. 
              Weather-resistant materials and vibrant colors that make an impact.
            </p>
            <div className="grid md:grid-cols-2 gap-4">
              <div className="space-y-3">
                <div className="flex items-center text-gray-300">
    ...
    <section className="py-20 bg-gradient-to-br from-black to-gray-900 min-h-screen">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-400 max-w-3xl mx-auto">
            Explore our portfolio of printing projects showcasing quality craftsmanship, 
            vibrant colors, and professional finishing across various printing services.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          {[
            ...
            <div key={index} className={`group relative overflow-hidden rounded-xl shadow-2xl hover:shadow-${item.color}-500/20 transition-all duration-300`}>
              <img 
                src={item.image}
                alt={item.title}
  ...
  const renderAboutPage = () => (
    <section className="py-20 bg-gradient-to-br from-black to-gray-900 min-h-screen">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h1 className="text-5xl font-bold text-white mb-6">About Ketan Graphics</h1>
          <p className="text-xl text-gray-400 max-w-3xl mx-auto">
            Your trusted partner for professional printing solutions with years of experience 
            in delivering exceptional quality and service to businesses across Navsari and beyond.
          </p>
        </div>
        ...
        <div className="grid lg:grid-cols-2 gap-12 mb-16">
          <div className="bg-gray-950 p-8 rounded-xl border border-gray-800">
            ...
            <p className="text-gray-300 mb-6">
              Established with a vision to provide comprehensive printing solutions, Ketan Graphics has grown 
              to become a trusted name in the printing industry. We specialize in multi-colour offset printing 
              with state-of-the-art equipment and a commitment to excellence.
            </p>
            <p className="text-gray-300 mb-6">
              Our journey began with a simple mission: to deliver high-quality printing services that exceed 
              customer expectations. Today, we serve businesses of all sizes, from small startups to large 
              corporations, providing them with professional printing solutions that help their brands shine.
            </p>
            <p className="text-gray-300">
              Located in the heart of Bilimora, Navsari, we combine traditional printing expertise with 
              modern technology to offer a complete range of printing services under one roof.
            </p>
          </div>
            ...
            <div className="space-y-6">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-400">Delivering superior printing quality with precise color matching and professional finishing.</p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-400">Building lasting relationships through exceptional service and reliable delivery.</p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-400">Embracing latest printing technologies and techniques for better results.</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="bg-gray-950 p-8 rounded-xl border border-gray-800 mb-16">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="text-center">
              ...
              <h3 className="text-lg font-semibold text-white mb-2">Digital Printing</h3>
              <p className="text-gray-400 text-sm">High-quality digital printing for quick turnaround projects.</p>
            </div>
            <div className="text-center">
              <div className="w-16 h-16 bg-cyan-400/20 rounded-full flex items-center justify-center mx-auto mb-4">
                <FileText className="h-8 w-8 text-cyan-400" />
              </div>
              <h3 className="text-lg font-semibold text-white mb-2">Offset Printing</h3>
              <p className="text-gray-400 text-sm">Commercial grade printing for large volume projects.</p>
            </div>
            <div className="text-center">
              <div className="w-16 h-16 bg-magenta-500/20 rounded-full flex items-center justify-center mx-auto mb-4">
                <Package className="h-8 w-8 text-magenta-400" />
              </div>
              <h3 className="text-lg font-semibold text-white mb-2">Large Format</h3>
              <p className="text-gray-400 text-sm">Banners, signage, and display materials for events.</p>
            </div>
            <div className="text-center">
              <div className="w-16 h-16 bg-yellow-500/20 rounded-full flex items-center justify-center mx-auto mb-4">
                <Palette className="h-8 w-8 text-yellow-400" />
              </div>
              <h3 className="text-lg font-semibold text-white mb-2">Specialty Services</h3>
              <p className="text-gray-400 text-sm">Custom finishing and specialty printing solutions.</p>
            </div>
          </div>
        </div>
        ...
        {/* Why Choose Us */}
        <div className="bg-gray-950 p-8 rounded-xl border border-gray-800">
          <h2 className="text-3xl font-bold text-white mb-8 text-center">Why Choose Ketan Graphics?</h2>
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <p className="text-gray-400">Fast processing and delivery without compromising quality. We understand the importance of meeting deadlines.</p>
            </div>
            <div className="text-center">
              ...
              <p className="text-gray-400">Multi-colour offset printing with precise CMYK color matching and superior finish using premium materials.</p>
            </div>
            <div className="text-center">
              ...
              <h3 className="text-xl font-semibold text-white mb-3">Complete Solutions</h3>
              <p className="text-gray-400">From design consultation to final delivery, we provide comprehensive printing services under one roof.</p>
            </div>
          </div>
        </div>
      </div>
  ...
  const renderContactPage = () => (
    <section className="py-20 bg-gradient-to-br from-black to-gray-900 min-h-screen">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h1 className="text-5xl font-bold text-white mb-6">Contact Ketan Graphics</h1>
          <p className="text-xl text-gray-400 max-w-3xl mx-auto">
            Ready to discuss your printing project? Get in touch with our experienced team today. 
            We're here to help bring your ideas to life with professional printing solutions.
          </p>
        </div>
        ...
        <div className="grid lg:grid-cols-2 gap-12 mb-16">
          {/* Contact Form */}
          <div className="bg-gray-950 p-8 rounded-xl border border-gray-800">
            <h2 className="text-3xl font-bold text-white mb-6">Get Your Quote Today</h2>
            ...
            <div className="bg-gray-950 p-8 rounded-xl border border-gray-800">
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h4 className="text-lg font-semibold text-white mb-1">Visit Our Shop</h4>
                    <p className="text-gray-300">
